        ...
        <SafeAreaView className="flex-1 bg-dark-50">
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                <View className="items-center px-6 pt-6 pb-8">
                    ...
                    <View className="bg-primary-100 px-3 py-1 rounded-full mt-2">
                        <Text className="font-lexend-medium text-xs text-primary-700">
                            {user?.role_obj?.role_name || "Student"}
                        </Text>
                    </View>
                </View>
                ...
                <View className="px-6">
                    ...
                    <MenuItem title="My Timetable" subtitle="View your class schedule" />
                    <MenuItem title="Assignments" subtitle="View assignments and status" />
                    <MenuItem title="Attendance" subtitle="View your attendance record" />
