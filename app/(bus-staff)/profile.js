...
export default function BusStaffProfile() {
                ...
                <View className="items-center px-6 pt-6 pb-8">
                    ...
                    <View className="bg-primary-100 px-3 py-1 rounded-full mt-2">
                        <Text className="font-lexend-medium text-xs text-primary-700">
                            {user?.role_obj?.role_name || "Bus Staff"}
                        </Text>
                    </View>
                </View>
                ...
                <View className="px-6">
                    ...
                    >
                        <View className="flex-1">
                            <Text className="font-lexend-medium text-sm text-dark-900">About EduSphere</Text>
                            <Text className="font-lexend text-xs text-dark-500 mt-0.5">Version 1.0.0</Text>
                        </View>
